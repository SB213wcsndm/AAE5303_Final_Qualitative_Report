...
|---|---:|---:|---|---|
| 1. Tooling & Reproducible Workflow Readiness | 1 | 4 | MacOS | Cursor is not that useful |
| 2. Prompting Strategy & AI Co-Creation | 1 | 4 | Reduced Drifting of IMU | Not to trust Ai can solve 100% of the problems |
| 3. Verification, Documentation & Technical Judgment | 1 | 3 | PPT is generated by Ai | Ai is not that good to point out key point |
