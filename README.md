...
| My strongest evidence | Using completely MacOS with Apple Silicon to complete the Visual SLAM |
...
| 2. Prompting Strategy & AI Co-Creation | 3 | 4 | Reduced Drifting of IMU | Not to trust Ai can solve 100% of the problems |
...
| 5. Integration & Benchmark-Driven Improvement | 1 | 4 | Scored 92.6 in Leaderboard | There are limitation with different methods |
| 6. Responsible AI Use, Reflection & Redesign | 4 | 5 | ORB-SLAM3 completion in MacOS, with satisfactory accuracy. |  |
...
### What this shows
It do generate slides with appropriate length for me, but it didn't come with those figures (e.g. parameters of VO / intrinsic / extrinsic).
