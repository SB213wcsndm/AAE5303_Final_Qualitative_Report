...
| 6. Responsible AI Use, Reflection & Redesign | 4 | 5 | ORB-SLAM3 completion in MacOS, with satifactory accuracy. |  |
...
### Limitation
I am lucky to found the solution in Stack Overflow (as I rmemeber), if no previous "masters", I will be stuck.
...
### Evidence
Since I can't overly increase the threshold for accuracy, that will impact the completness, I opt for increasing the features for overflowing "references" for SLAM.
...
### Evidence
ORB-SLAM3 completion in MacOS, with satifactory accuracy.
